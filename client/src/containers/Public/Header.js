...
const { CiCirclePlus, FaChevronDown, LuLogOut, FaPiggyBank, PiGarageFill } =
  icons;
    ...
    <div ref={headerRef} className="w-3/5 h-[40px] pt-3 flex items-center">
      <div className="w-full items-center flex justify-between">
        ...
        <div className="flex items-center gab-1">
          ...
          {isLoggedIn && (
            <div className="flex items-center gab-1 relative z-50">
              <small>
                <User />
              </small>
              <Button
              ...
              />
              {isShowMenu && (
                <div className="absolute min-w-200 top-full bg-white shadow-md rounded-md py-2 px-4 right-0 flex flex-col ">
                  ...
                  <span
                    className="cursor-pointer py-2 hover:text-orange-500 text-blue-600 flex items-center gap-2"
                    onClick={() => {
